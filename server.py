...
from backend import sending_payload as sending_payload_module
...
def sending_payload():
    ...
    utils = {
        ...
        'get_payload_config': get_payload_config,
        'get_payload_order': get_payload_order,
        'get_payload_delay_flags': get_payload_delay_flags,
        'send_payload': send_payload,
        'PAYLOAD_DIR': PAYLOAD_DIR,
        'ELF_DIR': ELF_DIR
    }
    return sending_payload_module.sending_payload(data, utils)
